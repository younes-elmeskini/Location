        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white/70 hover:text-[#FF9E0C] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/" className="text-white/80 hover:text-[#FF9E0C] transition-colors">
                  Accueil
                </a>
              </li>
              <li>
                <a href="/cars" className="text-white/80 hover:text-[#FF9E0C] transition-colors">
                  Nos véhicules
                </a>
              </li>
              <li>
                <a href="/About" className="text-white/80 hover:text-[#FF9E0C] transition-colors">
                  À propos
                </a>
              </li>
              <li>
                <a href="/auth/login" className="text-white/80 hover:text-[#FF9E0C] transition-colors">
                  Connexion
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-white/20 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/70 text-sm">
              © 2025 <a href="https://elmeskini.site/">DevUnes</a>. Tous droits réservés.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className="text-white/70 hover:text-[#FF9E0C] text-sm transition-colors">
